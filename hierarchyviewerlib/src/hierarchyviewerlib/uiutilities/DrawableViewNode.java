...
public class DrawableViewNode {
    ...
    public void setScreenShot(byte[] screenshot)
    {
    	...
    	mScreenShot=new Image(PlatformUI.getWorkbench().getDisplay(),in);
    }
    ...
    public void setScreenShot(String imagePath)
    {
    	...
    	mScreenShot = new Image(PlatformUI.getWorkbench().getDisplay(),imagePath);
    }
    ...
    public void move(double distance) {
        ...
        while (node.parent != null) {
            int index = node.viewNode.elementIndex;
