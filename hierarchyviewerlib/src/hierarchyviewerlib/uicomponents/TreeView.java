                ...
                if (mTree != null && mViewport != null && mSelectedNode != null) {
                    switch (e.keyCode) {
                        ...
                        case SWT.ARROW_UP:
                            ...
                            while (currentNode.parent != null && currentNode.viewNode.elementIndex == 0) {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            synchronized (TreeView.this) {
                if (mTree != null && mViewport != null) {
                    ...
                    DrawableViewNode newSelectedNode = mTree.getSelected(pt.x, pt.y);

                 // Update the selection.
                    if (newSelectedNode!= null && newSelectedNode != mSelectedNode) {
                    ...
                    //binhua only when click right button, begin to drag 
                    if(e.button==1)
                    {
                    	mDraggedNode=newSelectedNode;
                    }
                    else
                    {
                    	mDraggedNode=null;
...
/*                        org.eclipse.swt.graphics.Point measureExtent =
    ...
    private static void paintRecursive(GC gc, Transform transform, DrawableViewNode node,
        ...
        String type = node.viewNode.type;
        ...
        drawTextInArea(gc, transform, type, x, y, contentWidth, fontHeight, 12, true);
        ...
        y += fontHeight + DrawableViewNode.CONTENT_INTER_PADDING;
        if(node.viewNode.namedProperties.containsKey("name"))
        {
        	String name=node.viewNode.namedProperties.get("name").value;
        	drawTextInArea(gc, transform, name, x, y, contentWidth, fontHeight, 9,
        			false);
        }
        
        //y += fontHeight + DrawableViewNode.CONTENT_INTER_PADDING;
        
        //drawTextInArea(gc, transform, "index/"+Integer.toString(node.viewNode.index), x, y, contentWidth, fontHeight,
        //        8, false);
