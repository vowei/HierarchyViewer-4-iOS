...
public class iOSLogFileNodeParser extends TreeViewParserBase {

	public static final String MISCELLANIOUS = "miscellaneous";
	private int protocolVersion=2;
	
	@Override
	public DrawableViewNode ParseTreeNode(Object treeObject,String imagePath) {
		NSDictionary rootDict=(NSDictionary)treeObject;
